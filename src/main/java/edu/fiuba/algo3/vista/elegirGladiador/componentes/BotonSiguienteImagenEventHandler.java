...
public class BotonSiguienteImagenEventHandler implements EventHandler<ActionEvent> {
    ...
    public BotonSiguienteImagenEventHandler(ArrayList<Image> imagenes, boolean right, ImageView imagenPerfilGladiador) {
        super();
