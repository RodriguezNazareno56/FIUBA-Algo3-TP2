...
public class CasoDeUso20Test {
    ...
    Path json = Paths.get("src/main/test/edu/fiuba/algo3/entrega_3/json_test_resources/CasoDeUso20.json");
    AlgoRoma algoRoma;
    ...
    @Test
    public void simularVerificarQueElJugadorPierdeUnaPartida() throws Exception {
        // Arrange
